...
start = do
  ...
  (navJog, tabJog) <- Bot.escolherNaviosBot -- Captura o tabuleiro e os navios do jogador
  
  putStrLn "Posicionando navios inimigos..."
  (navBot, tabBot) <- Bot.escolherNaviosBot -- Captura o tabuleiro e os navios do bot
